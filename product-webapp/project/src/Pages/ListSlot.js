...
function ListSlot() {
    ...
    const listSubmit = () => {
        ...
        axios.get(`http://184.169.172.231:8080/booking-Management/api/v1/slotslist/groundID/`+sessionStorage.getItem("groundID"))
        .then((res)=>{
    ...
    const slot_delete = (slotId) => {
      ...
      axios
        .delete(`http://184.169.172.231:8080/booking-Management/api/v1/slot/slotID/${slotId}`)
        .then((response) => {
          listSubmit();
